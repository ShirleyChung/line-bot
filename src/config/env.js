...
export const env = {
  ...
  API_FOOTBALL_WORLD_CUP_LEAGUE_ID: Number(process.env.API_FOOTBALL_WORLD_CUP_LEAGUE_ID || 1),
  API_FOOTBALL_WORLD_CUP_SEASON: Number(process.env.API_FOOTBALL_WORLD_CUP_SEASON || 2026),
...
- 「頭條新聞/今日頭條/重點新聞/CNN 頭條」使用 get_top_headlines（max 預設 10，回傳多來源原始標題與連結）。
